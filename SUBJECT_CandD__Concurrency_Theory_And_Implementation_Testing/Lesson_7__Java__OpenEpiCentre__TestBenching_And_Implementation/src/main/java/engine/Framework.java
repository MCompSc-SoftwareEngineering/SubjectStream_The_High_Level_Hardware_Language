...
public class Framework
{
    ...
    public Framework() {
        ...
        System.out.printf("started independent STRUCT Algorithim().%n");
        stat_STRUCT_boot1_DEFINE_Algorithim();
        stat_STRUCT_boot3_INITIALISE_Algorithim();
        this.dyn_STRUCT_get_Algorithim().dyn_REG_boot1_DEFINE_Algorithim();
        this.dyn_STRUCT_get_Algorithim().dyn_REG_boot2_SUBSTANTIATE_Algorithim();
        this.dyn_STRUCT_get_Algorithim().dyn_REG_boot3_INITIALISE_Algorithim(this.dyn_STRUCT_get_User_Algorithm());
        System.out.printf("done independent STRUCT Algorithim().%n");
