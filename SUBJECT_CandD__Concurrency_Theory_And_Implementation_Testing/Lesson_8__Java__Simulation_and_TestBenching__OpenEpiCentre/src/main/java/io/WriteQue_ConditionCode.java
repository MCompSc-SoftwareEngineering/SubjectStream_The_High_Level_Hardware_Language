...
public class WriteQue_ConditionCode {
    ...
    {
        try {
            return Global.stat_CONVERT_LsbByteArray_To_LsbBoolean(JavaWriteQue_ConditionCode.INSTANCE.CLIB_WriteEnableForThreadsAt_ConditionCode_InputSamples__App_FUNCT_get_flag_isPGM_INSTANTIATED());
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaWriteQue_ConditionCode.INSTANCE.CLIB_WriteEnableForThreadsAt_ConditionCode_InputSamples__App_FUNCT_write_End(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbInt_To_LsbByteArray(threadId)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaWriteQue_ConditionCode.INSTANCE.CLIB_WriteEnableForThreadsAt_ConditionCode_InputSamples__App_FUNCT_write_Start(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbInt_To_LsbByteArray(threadId)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
