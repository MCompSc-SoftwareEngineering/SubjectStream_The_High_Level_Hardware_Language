...
public class WriteQue_ClientUserOutput
{
    ...
    {
        try {
            return Global.stat_CONVERT_LsbByteArray_To_LsbBoolean(JavaLIB_WriteQueForThreadsAt_ClientUserOutput.INSTANCE.CLIB_WriteEnableForThreadsAt_ClientUserOutput__App_FUNCT_get_FLAG_isPGM_INSTANTIATED());
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_WriteQueForThreadsAt_ClientUserOutput.INSTANCE.CLIB_WriteEnableForThreadsAt_ClientUserOutput__App_FUNCT_write_End(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbInt_To_LsbByteArray(threadId)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_WriteQueForThreadsAt_ClientUserOutput.INSTANCE.CLIB_WriteEnableForThreadsAt_ClientUserOutput__App_FUNCT_write_Start(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbInt_To_LsbByteArray(threadId)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
