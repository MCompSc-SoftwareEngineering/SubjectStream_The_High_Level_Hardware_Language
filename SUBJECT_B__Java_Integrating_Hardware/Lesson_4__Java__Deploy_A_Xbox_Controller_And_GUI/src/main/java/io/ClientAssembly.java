...
//TODO post process THREADS
        System.out.printf("started independent STRUCT EventListener_XBoxController() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
        stat_CLASS_get_Framework().dyn_STRUCT_boo1_DEFINE_XboxController();
        stat_CLASS_get_Framework().dyn_STRUCT_boot3_INITIALISE_XboxController();
        stat_CLASS_get_Framework().dyn_THREAD_boot1_DEFINE_EventListener_XBoxController();
        System.out.printf("done independent STRUCT EventListener_XBoxController() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
        ...
        stat_CLASS_get_Framework().dyn_THREAD_boot3_INITIALISE_EventListener_XBoxController(stat_CLASS_get_Framework());
