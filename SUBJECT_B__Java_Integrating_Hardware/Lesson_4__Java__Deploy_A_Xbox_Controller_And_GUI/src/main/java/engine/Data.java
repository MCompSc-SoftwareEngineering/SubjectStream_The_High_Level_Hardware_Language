...
public class Data
{
	...
	{
		return stat_REG_get_doublebuffer_Client_InputSend()[stat_CONVERT_boolean_To_byte(!obj.dyn_CLASS_get_Framework_App().dyn_CLASS_get_Data().dyn_CLASS_get_data_Control().dyn_REG_get_StateWRITE_doublebuffer_Client_InputSend())];
	}
	...
	{
		return stat_REG_get_doublebuffer_Client_OutputRecieve()[stat_CONVERT_boolean_To_byte(!obj.dyn_CLASS_get_Framework_App().dyn_CLASS_get_Data().dyn_CLASS_get_data_Control().dyn_REG_get_StateWRITE_doublebuffer_Client_OutputRecieve())];
	}
