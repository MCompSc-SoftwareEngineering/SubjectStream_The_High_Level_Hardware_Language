...
public class MyDLL {
    public static Pointer stat_App_FUNCT_MyLIBS__CLIB_MyDLL__generate_Program()
    {
        ...
        temp = (Pointer)null;
        try {
            temp = JavaLIB_MyDLL.INSTANCE.stat_App_FUNCT_MyLIBS__CLIB_MyDLL__generate_Program();
        }
    ...
    public static boolean stat_App_FUNCT_MyLIBS__CLIB_MyDLL__get_flag_isPGM_INSTANTIATED()
    {
        ...
        try {
            temp = JavaLIB_MyDLL.INSTANCE.stat_App_FUNCT_MyLIBS__CLIB_MyDLL__get_flag_isPGM_INSTANTIATED();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_App_FUNCT_MyLIBS__CLIB_MyDLL__terminate_Program();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_do_FUNCT_MyLIBS__CLIB_MyDLL__add_a_b();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_do_FUNCT_MyLIBS__CLIB_MyDLL__subtract_a_b();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_do_FUNCT_MyLIBS__CLIB_MyDLL__multiply_a_b();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_do_FUNCT_MyLIBS__CLIB_MyDLL__divide_a_b();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static double stat_get_FUNCT_MyLIBS__CLIB_MyDLL__Output__value()
    {
        ...
        try {
            temp = JavaLIB_MyDLL.INSTANCE.stat_get_FUNCT_MyLIBS__CLIB_MyDLL__Output__value();
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_set_FUNCT_MyLIBS__CLIB_MyDLL_Input__value_a(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbDouble_To_LsbByteArray(value)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    {
        try {
            JavaLIB_MyDLL.INSTANCE.stat_set_FUNCT_MyLIBS__CLIB_MyDLL_Input__value_b(Global.stat_CONVERT_LsbByteArray_To_MsbByteArray(Global.stat_CONVERT_LsbDouble_To_LsbByteArray(value)));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
